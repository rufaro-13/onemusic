...
const [link, setLink] = useState("");
 ...
 const [dataToShow, setData] = useState([]);
  ...
  let song ="";
  let isMusicToggle = !isMusic;
  console.log('new song is',sing) 
   setPlaying(sing);
   console.log('new link is',link);

  if (isMusicToggle ) {
    song = sing;
    audioRef.current= new Audio(sing);
     isMusicToggle = true; 
  ...
  else 
  {
     ...
     // console.log('new link is',link);
      /* if(sing !== link)
      {
        song = sing;
    audioRef.current= new Audio(sing);
     isMusicToggle = !isMusic; 
    audioRef.current.play();
      } */
     
  }
   isMusicSet(isMusicToggle);
  console.log('status is',isMusic);  
  setLink(song);
  console.log('new link is',link);
