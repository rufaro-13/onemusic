      ...
      <div className="container h-full px-6 py-2">
        <div className=" shadow-lg bg-gray-200 flex h-dvh justify-items-center w-2/3 md:px-5 pt-10 item-stretch ">
          {/* <!-- Left column container with background--> */}
            <div className="mb-12 mx-5 flex-1 w-1/2 bg-white border-2 pt-12 md:mb-0 max-w-full">
                <img  src="https://tecdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.svg" alt="logo" className="w-2/3" 
                />
            </div>

          {/* <!-- Right column container with form --> */}
            <div className="justify-items-stretch w-1/2 h-dvh bg-white rounded shadow-lg pl-12 pr-10 pt-8 flex-1 max-w-1/2">
            <div className=" w-68 bg-white rounded shadow-lg pl-12 pr-10 h-full flex-none max-w-full">
                <form action="http://localhost:8000/server.php"
                method="post" className="mx-5 pt-5" 
