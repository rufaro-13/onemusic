  ...
  return (
    <section className="mt-5 max-h-screen">
      ...
      <div className="container h-full px-6 py-2">
        <div className=" shadow-lg bg-gray-200 lg:flex h-dvh justify-items-center w-2/3 md:px-5 pt-10 item-stretch ">
          {/* <!-- Left column container with background--> */}
            <div className="mb-12 mx-5 flex-1 w-full lg:w-1/2 bg-white border-2 pt-12 md:mb-0 max-w-full">
                <img  src="https://tecdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.svg" alt="logo" className="w-2/3" 
                />
            </div>

          {/* <!-- Right column container with form --> */}
            <div className="justify-items-stretch w-full lg:w-1/2 h-full bg-white rounded shadow-lg mt-2 lg:pl-12 lg:pr-10 pt-8 flex-1 lg:max-w-1/2 max-w-full">
            <div className="w-full lg:w-68 bg-white rounded shadow-lg pl-12 pr-10 h-full flex-none max-w-full">
            ...
            onChange={handlePassword}/>
                ...
                <div className="mb-6 lg:flex items-center justify-between">
                    ...
                    <div className="mx-5 pt-2 lg:pt-5 lg:w-1/2 w-full" >
                        <a
                        className="mb-3 lg:flex w-full items-center justify-center rounded bg-primary lg:px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
                    ...
                    <TERipple rippleColor="light" className="w-full"> */}
                     <div className="mx-5 pt-2 lg:pt-5 lg:w-1/2 w-full" >
                        <a
                        className="mb-3 lg:flex w-full items-center justify-center rounded bg-info lg:px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#54b4d3] transition duration-150 ease-in-out hover:bg-info-600 hover:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] focus:bg-info-600 focus:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] focus:outline-none focus:ring-0 active:bg-info-700 active:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(84,180,211,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)]"
